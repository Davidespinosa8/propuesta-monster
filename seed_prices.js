...
const preciosReferencia = [
  // 1. ALBAÑILERÍA (Tu lista original)
  {
    id: "albanil",
  ...
  // 2. ELECTRICIDAD (Tu lista original)
  {
    id: "electricista",
  ...
  // 7. 🔥 DIGITAL / DISEÑO (NUEVA CATEGORÍA) 🔥
  {
    id: "digital",
    ...
    items: [
      ...
      { id: "mkt_copy", task: "Redacción de Contenidos / Copywriting", unit: "Pack 5", price: 90000 },
...
async function seed() {
  ...
  try {
    ...
    console.log("Ahora incluye: Albañilería, Plomería, Gas, Electricidad, Durlock, Pintura y DIGITAL.");
    process.exit(0);
  } catch (error) {
    console.error("\n❌ ERROR FATAL:", error);
    process.exit(1);
